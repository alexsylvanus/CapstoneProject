...
#Manually enter Calibration coeficcients found with MATLAB script
rightCameraMatrix = np.array([[626.45, 0, 349.58],[0, 624.85, 237.25], [0, 0, 1]], np.float64)
rightDistortionCoefficients = np.array([-0.41073, 0.81301, 0.00006, -0.00052, 0.000], np.float64)
...
np.savez_compressed(outputFile, imageSize=imageSize,
        ...
        rightMat=rightCameraMatrix, rightCo=rightDistortionCoefficients)
